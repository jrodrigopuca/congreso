...
function actualizarArchivo($ubicacion, $id){
    $pdo=conecta();
    $sql = "UPDATE trabajos SET trabajos.t_comprobante=:ubicacion where trabajos.id=:id";
    ...
    if ($resp){
        ...
        $text.= "<p>Tenemos el agrado de dirigirnos a Ud. a los fines de comunicar la recepción del comprobante de pago. Saludos</p>";
...
<body>
    ...
    <div class="alert alert-danger" role="alert">
            ...
            <p>
            La plataforma recibirá los comprobantes de pago hasta el 27/04/18 00:00:00 hs UTC-3
            </p>
    </div>
    -->
    <div class="centrar card">
        ...
        <form class="card-body" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]."?ref=".$_GET['ref']); ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <span class="help-block"> Solo se aceptarán jpg/jpeg/png, tamaño máximo 25MB</span>
           </div>
        ...
        <?php
            if($_SERVER["REQUEST_METHOD"] == "POST"){
                $ubicacionArchivo= subirArchivoV($_FILES["file_pdf"], "jpg", "comprobantes");
                if ($ubicacionArchivo!=""){
